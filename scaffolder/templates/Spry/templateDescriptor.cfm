...
<!--- 
This is a template descriptor file for the Spry Templates.
The templates will spry based pages for a maintenance application built with the Coldspring templates.
 --->
 
<!--- Create a description of each of the templates. --->
<!--- This is the list for Spry --->
<cfscript>
