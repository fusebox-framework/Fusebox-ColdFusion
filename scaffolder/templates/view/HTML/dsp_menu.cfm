...
--->>
<<!--- I create the menu with a link to a list page for each table in the database --->>
<<cfoutput>>
<cfsilent>
<!--- -->
<fusedoc fuse="dsp_menu.cfm" language="ColdFusion 7.01" version="2.0">
	<responsibilities>
		I display the menu with a link to a list of records for each table.
	</responsibilities>
	<properties>
...
<ul>
	...
	<li><a href="#myFusebox.getSelf()#?fuseaction=$$oMetaData.getProject()$$.$$thisObject$$_List">$$thisObject$$</a></li><</cfloop>>
</ul>
</cfoutput>
<</cfoutput>>
