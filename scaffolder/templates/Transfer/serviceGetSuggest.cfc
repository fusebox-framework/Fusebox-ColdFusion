...
<<cfoutput>>
	<cffunction name="getLike" access="remote" output="false" returntype="query">
	  ...
	  <<cfloop from="1" to="$$ArrayLen(aFields)$$" index="i">>
		...
		<cfset var aSuggest = arrayNew(1)>
		<cfset var qSuggest = variables.$$objectName$$Gateway.getLikeFields(argumentCollection=arguments) />
		<!--- TODO: Complete this code to support autosuggest control --->
	</cffunction>
<</cfoutput>>