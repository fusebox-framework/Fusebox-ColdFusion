	...
	<cffunction name="read" access="public" output="false" returntype="boolean">
		...
		<cftry>
			<cfquery name="qRead" datasource="#variables.dsn#">
				SELECT	<<cfloop from="1" to="$$ArrayLen(aFields)$$" index="i">>$$tableName$$.$$aFields[i].name$$ AS $$aFields[i].alias$$<<cfif i NEQ ArrayLen(aFields) OR ArrayLen(aJoinedFields) GT 0 >>,$$chr(10)$$<</cfif>>							<</cfloop>>
