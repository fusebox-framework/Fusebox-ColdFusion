...
<<cfloop from="1" to="$$ArrayLen(aJoinedFields)$$" index="i">><<cfset lFields = ListAppend(lFields, aJoinedFields[i].alias)>>
	<cffunction name="set$$aJoinedFields[i].table$$$$aJoinedFields[i].alias$$" access="package" returntype="void" output="false">
		<cfargument name="$$aJoinedFields[i].table$$$$aJoinedFields[i].alias$$" type="any" required="true" />
		<cfset variables.instance.$$aJoinedFields[i].table$$$$aJoinedFields[i].alias$$ = arguments.$$aJoinedFields[i].table$$$$aJoinedFields[i].alias$$ />
	</cffunction>
	<cffunction name="get$$aJoinedFields[i].table$$$$aJoinedFields[i].alias$$" access="public" returntype="any" output="false">
		<cfreturn variables.instance.$$aJoinedFields[i].table$$$$aJoinedFields[i].alias$$ />
	</cffunction>
<</cfloop>>
