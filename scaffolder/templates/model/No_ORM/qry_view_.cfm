...
<cfsilent>
<!--- -->
<fusedoc fuse="qry_view_$$objectName$$.cfm" language="ColdFusion 7.01" version="2.0">
	<responsibilities>
		I set up the $$objectName$$ service object, get the required object and any linked parent objects.
	</responsibilities>
	<properties>
